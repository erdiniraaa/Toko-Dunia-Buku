...
(3, 'Auguste Dupin : Detektif Prancis', 30000, 130, 'tb2.jpg', 'Mungkin banyak yang mengira bahwa Sherlock Holmes adalah pionir tokoh detektif fiksi di dunia literasi. Tapi jauh sebelum Sherlock Holmes muncul, ada tokoh lain yang lebih dulu memulai dan menyandang predikat gentlemen detective, yaitu C Auguste Dupin yang diciptakan oleh Edgar Allan Poe.', 'tb2alt.jpg', 1),
(4, 'Harry Potter and the Half Blood Prince', 100000, 300, 'tb3.jpg', 'Khwatir dengan pengalaman pertemuannya dengan Voldemort di Kementerian Sihir, Harry Potter merasa enggan untuk kembali ke Hogwarts. Namun, Dumbledore mengajaknya untuk menemui Horace Slughorn yang akhirnya kembali mengajar di Hogwarts.', 'tb3alt.jpg', 2),
(5, 'The Hobbit : There and Back Again', 100000, 190, 'tb4.jpg', 'Kisah Bilbo Baggins yang enggan meninggalkan rumah nyaman di Shire hingga Gandalf dan 13 Kurcaci datang dan mengajaknya berpetualang yang tak terduga.', 'tb4alt.jpg', 0),
(6, 'Andrea Hirata : Laskar Pelangi', 40000, 100, 'tb5.jpg', 'Laskar Pelangi adalah cerita tentang perjuangan sekelompok anak-anak desa miskin di Belitung untuk memperbaiki masa depan mereka melalui pendidikan.', 'tb5alt.jpg', 1),
(7, 'Agatha Christie : The Pale Horse', 50000, 90, 'tb6.jpg', 'Seorang wanita memanggil pastor di saat sedang sekarat untuk menceritakan rahasia kelam hidupnya, termasuk memberikan daftar nama. Pastor tersebut dibunuh setelah meninggalkan wanita itu.', 'tb6alt.jpg', 1);

-- --------------------------------------------------------
-- Adding AUTO_INCREMENT and Primary Keys where necessary
-- --------------------------------------------------------

-- Add AUTO_INCREMENT for table `admin`
ALTER TABLE `admin`
  MODIFY `id_admin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

-- Add AUTO_INCREMENT for table `kurir`
ALTER TABLE `kurir`
  MODIFY `id_kurir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

-- Add AUTO_INCREMENT for table `pelanggan`
ALTER TABLE `pelanggan`
  MODIFY `id_pelanggan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

-- Add AUTO_INCREMENT for table `pembayaran`
ALTER TABLE `pembayaran`
  MODIFY `id_pembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

-- Add AUTO_INCREMENT for table `pembelian`
ALTER TABLE `pembelian`
  MODIFY `id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

-- Add AUTO_INCREMENT for table `pembelian_produk`
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

-- Add AUTO_INCREMENT for table `produk`
ALTER TABLE `produk`
