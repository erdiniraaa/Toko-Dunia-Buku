<?php
    //account dimasukkan kedalam session dan akan koneksi ke database
    session_start();
    
    $koneksi = new mysqli("localhost","root","","tokobuku2");
...
// navigasi untuk logout 
           ...
           <!-- /. NAVigasi samping untuk sidebar/menampilkan tampilan ke semua halaman  dalam admin -->
...
//dimana code ini untuk membuat admin panel yang memiliki fitur-fitur (sperti autentikasi admin navigasi dll)