...
// Menampilkan informasi pembelian 
				...
				<?php if (!empty($detail['resi_pengiriman'])): ?>
							...
							<?php endif  ?>
// Informasi pelanggan, pengirim, dan alamat pengirim 
			<div class="row">
				<div class="col-md-4">
...
// menghitung rital belanja dan tampilan tarif
				<tfoot>
					<tr>
...
// ini adalah halaman detail pembelian dalam sistem dimana ini menampilkan rincian transaksi pembelian yang di lakukan oleh pelanggan
//Kode ini digunakan untuk:

//Mengambil data pembelian dari database.
//Menampilkan informasi pembelian seperti kode, tanggal, harga total, status, nomor resi (jika ada), dan data pelanggan.
//Menampilkan detail produk yang dibeli beserta harga dan jumlah.
//Menghitung total belanja yang termasuk tarif pengiriman.