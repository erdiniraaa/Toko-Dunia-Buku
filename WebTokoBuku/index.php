  ...
  <div id="container">
    <div id="header">
      <div class="headerBackground">
        <h1><font color="#f8192e"><br><br><b>&nbsp;&nbsp;Selamat Datang Di toko Buku Kami Dan selamat belanja</font><font color="#ffffff">xixi</font></b></h1>
      </div>
    </div>
  <body>
...
<!-- Bagian footer -->
    ...
    <div class="row" style="background: black;">
      <nav class="footer">
            <footer class="copyright text-center"><p>&copy; Copyright Toko Buku 2020</p></footer>
        </div>
      </nav>
    </div>
</body>
